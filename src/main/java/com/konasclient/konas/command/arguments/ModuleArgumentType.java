...
public class ModuleArgumentType implements ArgumentType<Module> {
    ...
    private static final DynamicCommandExceptionType NO_SUCH_MODULE = new DynamicCommandExceptionType(o -> new LiteralText("Module with name " + o + " doesn't exist."));
    ...
    public Module parse(StringReader reader) throws CommandSyntaxException {
        ...
        Module module = ModuleManager.get(argument);
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
        return CommandSource.suggestMatching(ModuleManager.getModulesAndAliases(), builder);
    }
